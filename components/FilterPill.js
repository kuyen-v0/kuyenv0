...
export default function FilterPill({ option, onClick=()=>{} }) {
  return (
    <button onClick={() => onClick(option)} className='flex items-center border border-white text-white rounded mt-4 mr-4 px-3 py-2 hover:shadow-2xl duration-300'>
      <p className='mr-2'>{option.filterName}: {option.optionName}</p>
