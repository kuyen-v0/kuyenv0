export default function EtherscanButton({ link }) {
  return (
    <a target="_blank" href={link} title="View on Etherscan" className="pt-1 hover:opacity-80 duration-200" rel="noreferrer">
      <svg className="fill-current stroke-current h-6 w-6 mb-1" xmlns="http://www.w3.org/2000/svg" width="293.775" height="293.671" viewBox="0 0 293.775 293.671">
